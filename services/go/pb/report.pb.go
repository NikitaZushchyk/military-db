...
type UniversalTableRequest struct {
...
func (x *UniversalTableRequest) Reset() {
	*x = UniversalTableRequest{}
	mi := &file_proto_report_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UniversalTableRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UniversalTableRequest) ProtoMessage() {}

func (x *UniversalTableRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_report_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use UniversalTableRequest.ProtoReflect.Descriptor instead.
func (*UniversalTableRequest) Descriptor() ([]byte, []int) {
	return file_proto_report_proto_rawDescGZIP(), []int{0}
}

func (x *UniversalTableRequest) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *UniversalTableRequest) GetHeaders() []string {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *UniversalTableRequest) GetRows() []*TableRow {
	if x != nil {
		return x.Rows
	}
	return nil
...
func (x *PdfResponse) GetFileData() []byte {
	if x != nil {
		return x.FileData
	}
	return nil
...
const file_proto_report_proto_rawDesc = "" +
	"\n" +
	"\x12proto/report.proto\x12\fpdfgenerator\"s\n" +
	"\x15UniversalTableRequest\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x18\n" +
	"\aheaders\x18\x02 \x03(\tR\aheaders\x12*\n" +
	"\x04rows\x18\x03 \x03(\v2\x16.pdfgenerator.TableRowR\x04rows\" \n" +
	"\bTableRow\x12\x14\n" +
	"\x05cells\x18\x01 \x03(\tR\x05cells\"*\n" +
	"\vPdfResponse\x12\x1b\n" +
	"\tfile_data\x18\x01 \x01(\fR\bfileData2e\n" +
	"\rReportService\x12T\n" +
	"\x10GenerateTablePdf\x12#.pdfgenerator.UniversalTableRequest\x1a\x19.pdfgenerator.PdfResponse\"\x00B\x06Z\x04./pbb\x06proto3"
...
var file_proto_report_proto_goTypes = []any{
	(*UniversalTableRequest)(nil), // 0: pdfgenerator.UniversalTableRequest
	(*TableRow)(nil),              // 1: pdfgenerator.TableRow
	(*PdfResponse)(nil),           // 2: pdfgenerator.PdfResponse
}
var file_proto_report_proto_depIdxs = []int32{
	1, // 0: pdfgenerator.UniversalTableRequest.rows:type_name -> pdfgenerator.TableRow
	0, // 1: pdfgenerator.ReportService.GenerateTablePdf:input_type -> pdfgenerator.UniversalTableRequest
	2, // 2: pdfgenerator.ReportService.GenerateTablePdf:output_type -> pdfgenerator.PdfResponse
